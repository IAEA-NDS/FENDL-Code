...
templates in the `templates` directory, which contain some strings
such as `FENDL-3.1d`, which may not appropriately describe what is
compared. These strings have to be changed manually either in the
template or in the produced html files.
